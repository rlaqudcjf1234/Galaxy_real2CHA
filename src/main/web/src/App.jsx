...
// const CodeList = lazy(()=> import('./pages/codegroup/List')) const CodeAdd =
// lazy(()=> import('./pages/codegroup/add'))
                ...
                <Routes>
                    ...
                    <Route path="/" element={<Layout />}>
                        ...
                        <Route path="class" element={<Container />}>
                            ...
                            <Route path="read/:seq" element={<ClassRead />}/> {/* <Route path="update/:seq" element={<ClassUpdate />} /> */}
                        </Route>
